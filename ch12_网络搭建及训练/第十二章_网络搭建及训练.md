...
主要特点：
>> - 1.增强卷积模块功能。
>>主要的创新在于他的 ==Inception，这是一种网中网==（Network In Network）的结构，即原来的结点也是一个网络。Inception一直在不断发展，目前已经V2、V3、V4。其中==1*1卷积主要用来降维==，用了Inception之后整个网络结构的宽度和深度都可扩大，能够带来2-3倍的性能提升。
